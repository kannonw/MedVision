...
class KneeMRIClassifier():
    def __init__(self, model_path="./app/models/KneeMRIClassifier/rmibest.h5"):
        super().__init__()
    ...
    def transforms(self, x):
        image = Image.open(BytesIO(x)).convert('RGB').resize((80,80))
